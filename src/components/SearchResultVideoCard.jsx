  ...
  return (
    <Link to={`/video/${video?.videoId}`}>
      <div className='flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4'>
        <div className="relative flex shrike-0 h-48 md:h-28 lg:h-40 xl:h-48 w-full md:w-48 lg:w-64 xl:w-80 rounded-xl bg-slate-800 overflow-hidden  ">
        ...
        <div className='flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden'>
          ...
          <div className="hidden md:flex items-center">
            ...
            <div className="flex flex-col">
              <span className="text-semibold mt-2 text-white/[0.7] flex items-center">
              {video?.author?.title}
